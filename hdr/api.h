...
#define SQL_H
	...
	#define ea_pet_search_sql "SELECT pet_script, loyal_script FROM ea_pet WHERE mob_id = ?;"
	#define ra_pet_search_sql "SELECT pet_script, loyal_script FROM ra_pet WHERE mob_id = ?;"
	#define he_pet_search_sql "SELECT pet_script, loyal_script FROM he_pet WHERE mob_id = ?;"
