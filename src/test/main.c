...
int main(int argc, char * argv[]) {
    ...
    rbt_logic_var_init(&logic_1, "a", range_1);
    rbt_logic_var_init(&logic_2, "b", range_1);
    rbt_logic_op(logic_1, logic_2, &logic_3, and);
    rbt_logic_deit(&logic_2);
    rbt_logic_deit(&logic_1);
    rbt_logic_var_init(&logic_1, "c", range_1);
    rbt_logic_var_init(&logic_2, "d", range_1);
    ...
    rbt_logic_var_init(&logic_1, "b", range_1);
    rbt_logic_var_init(&logic_2, "c", range_2);
    rbt_logic_var_init(&logic_3, "d", range_1);
    ...
    /* test and_and_or */
    rbt_logic_var_init(&logic_1, "a", range_1);
    rbt_logic_var_init(&logic_2, "b", range_2);
    rbt_logic_op(logic_1, logic_2, &logic_3, and);
    rbt_logic_deit(&logic_2);
    rbt_logic_deit(&logic_1);
    rbt_logic_var_init(&logic_1, "c", range_1);
    rbt_logic_var_init(&logic_2, "d", range_2);
    ...
    rbt_logic_var_init(&logic_1, "a", range_1);
    rbt_logic_var_init(&logic_2, "a", range_3);
