...
#define DB_RATHENA_H
	...
	#define RA_ITEM_GROUP_INSERT 	"INSERT INTO item_group_ra VALUES(?, ?, ?);"
	#define RA_ITEM_GROUP_CREATE 	"CREATE TABLE IF NOT EXISTS item_group_ra("\
									"	group_id INTEGER,"\
									"	item_id INTEGER,"\
									"	rate INTEGER"\
									");"
	#define RA_ITEM_GROUP_DELETE 	"DROP TABLE IF EXISTS item_group_ra;"
	...
	int ra_db_item_pacakage_load(ra_db_t *, const char *);
